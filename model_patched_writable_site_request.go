...
type PatchedWritableSiteRequest struct {
	...
	Owner                NullableCustomFieldRequestOwner `json:"owner,omitempty"`
...
// SetStatus gets a reference to the given PatchedWritableSiteRequestStatus and assigns it to the Status field.
...
func (o *PatchedWritableSiteRequest) GetOwner() CustomFieldRequestOwner {
	if o == nil || IsNil(o.Owner.Get()) {
		var ret CustomFieldRequestOwner
		return ret
	}
	return *o.Owner.Get()
}
...
// SetOwner gets a reference to the given NullableCustomFieldRequestOwner and assigns it to the Owner field.
