...
// EnvironmentRequest Adds support for custom fields and tags.
...
type _EnvironmentRequest EnvironmentRequest
...
func (o *EnvironmentRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varEnvironmentRequest := _EnvironmentRequest{}

	err = json.Unmarshal(data, &varEnvironmentRequest)

	if err != nil {
		return err
	}

	*o = EnvironmentRequest(varEnvironmentRequest)
