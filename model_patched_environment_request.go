...
// checks if the PatchedEnvironmentRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedEnvironmentRequest{}

// PatchedEnvironmentRequest Adds support for custom fields and tags.
type PatchedEnvironmentRequest struct {
...
type _PatchedEnvironmentRequest PatchedEnvironmentRequest
...
func NewPatchedEnvironmentRequest() *PatchedEnvironmentRequest {
	this := PatchedEnvironmentRequest{}
	return &this
}
...
func (o PatchedEnvironmentRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedEnvironmentRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedEnvironmentRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedEnvironmentRequest := _PatchedEnvironmentRequest{}

	err = json.Unmarshal(data, &varPatchedEnvironmentRequest)

	if err != nil {
		return err
	}

	*o = PatchedEnvironmentRequest(varPatchedEnvironmentRequest)
...
type NullablePatchedEnvironmentRequest struct {
	value *PatchedEnvironmentRequest
	isSet bool
}

func (v NullablePatchedEnvironmentRequest) Get() *PatchedEnvironmentRequest {
	return v.value
}

func (v *NullablePatchedEnvironmentRequest) Set(val *PatchedEnvironmentRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedEnvironmentRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedEnvironmentRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedEnvironmentRequest(val *PatchedEnvironmentRequest) *NullablePatchedEnvironmentRequest {
	return &NullablePatchedEnvironmentRequest{value: val, isSet: true}
}

func (v NullablePatchedEnvironmentRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedEnvironmentRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
