...
// WritableNestedSubnetPrefixRequest Writable nested SubnetPrefix serializer. Used for creating/updating prefixes within a Subnet. Does NOT include 'subnet' field to avoid circular import.
