...
`func (o *TenantRequest) GetOwner() CustomFieldRequestOwner`

GetOwner returns the Owner field if non-nil, zero value otherwise.

### GetOwnerOk

`func (o *TenantRequest) GetOwnerOk() (*CustomFieldRequestOwner, bool)`
...
`func (o *TenantRequest) SetOwner(v CustomFieldRequestOwner)`
