...
`func (o *EventRuleRequest) GetOwner() CustomFieldRequestOwner`

GetOwner returns the Owner field if non-nil, zero value otherwise.

### GetOwnerOk

`func (o *EventRuleRequest) GetOwnerOk() (*CustomFieldRequestOwner, bool)`
...
`func (o *EventRuleRequest) SetOwner(v CustomFieldRequestOwner)`
