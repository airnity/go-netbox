...
`func (o *PatchedWritableSiteGroupRequest) GetOwner() CustomFieldRequestOwner`

GetOwner returns the Owner field if non-nil, zero value otherwise.

### GetOwnerOk

`func (o *PatchedWritableSiteGroupRequest) GetOwnerOk() (*CustomFieldRequestOwner, bool)`
...
`func (o *PatchedWritableSiteGroupRequest) SetOwner(v CustomFieldRequestOwner)`
