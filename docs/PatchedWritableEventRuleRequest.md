...
`func (o *PatchedWritableEventRuleRequest) GetOwner() CustomFieldRequestOwner`

GetOwner returns the Owner field if non-nil, zero value otherwise.

### GetOwnerOk

`func (o *PatchedWritableEventRuleRequest) GetOwnerOk() (*CustomFieldRequestOwner, bool)`
...
`func (o *PatchedWritableEventRuleRequest) SetOwner(v CustomFieldRequestOwner)`
