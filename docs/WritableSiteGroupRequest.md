...
`func (o *WritableSiteGroupRequest) GetOwner() CustomFieldRequestOwner`

GetOwner returns the Owner field if non-nil, zero value otherwise.

### GetOwnerOk

`func (o *WritableSiteGroupRequest) GetOwnerOk() (*CustomFieldRequestOwner, bool)`
...
`func (o *WritableSiteGroupRequest) SetOwner(v CustomFieldRequestOwner)`
