...
`func (o *CustomFieldRequest) GetOwner() CustomFieldRequestOwner`

GetOwner returns the Owner field if non-nil, zero value otherwise.

### GetOwnerOk

`func (o *CustomFieldRequest) GetOwnerOk() (*CustomFieldRequestOwner, bool)`
...
`func (o *CustomFieldRequest) SetOwner(v CustomFieldRequestOwner)`
