...
`func (o *PatchedWritableCustomFieldRequest) GetOwner() CustomFieldRequestOwner`

GetOwner returns the Owner field if non-nil, zero value otherwise.

### GetOwnerOk

`func (o *PatchedWritableCustomFieldRequest) GetOwnerOk() (*CustomFieldRequestOwner, bool)`
...
`func (o *PatchedWritableCustomFieldRequest) SetOwner(v CustomFieldRequestOwner)`
