...
`func (o *WebhookRequest) GetOwner() CustomFieldRequestOwner`

GetOwner returns the Owner field if non-nil, zero value otherwise.

### GetOwnerOk

`func (o *WebhookRequest) GetOwnerOk() (*CustomFieldRequestOwner, bool)`
...
`func (o *WebhookRequest) SetOwner(v CustomFieldRequestOwner)`
