...
`func (o *PatchedWritableTenantGroupRequest) GetOwner() CustomFieldRequestOwner`

GetOwner returns the Owner field if non-nil, zero value otherwise.

### GetOwnerOk

`func (o *PatchedWritableTenantGroupRequest) GetOwnerOk() (*CustomFieldRequestOwner, bool)`
...
`func (o *PatchedWritableTenantGroupRequest) SetOwner(v CustomFieldRequestOwner)`
