...
`func (o *SiteGroupRequest) GetOwner() CustomFieldRequestOwner`

GetOwner returns the Owner field if non-nil, zero value otherwise.

### GetOwnerOk

`func (o *SiteGroupRequest) GetOwnerOk() (*CustomFieldRequestOwner, bool)`
...
`func (o *SiteGroupRequest) SetOwner(v CustomFieldRequestOwner)`
