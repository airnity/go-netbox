...
`func (o *WritableEventRuleRequest) GetOwner() CustomFieldRequestOwner`

GetOwner returns the Owner field if non-nil, zero value otherwise.

### GetOwnerOk

`func (o *WritableEventRuleRequest) GetOwnerOk() (*CustomFieldRequestOwner, bool)`
...
`func (o *WritableEventRuleRequest) SetOwner(v CustomFieldRequestOwner)`
