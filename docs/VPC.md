...
`func (o *VPC) SetMetadataNil(b bool)`

 SetMetadataNil sets the value for Metadata to be an explicit nil

### UnsetMetadata
`func (o *VPC) UnsetMetadata()`

UnsetMetadata ensures that no value is present for Metadata, not even an explicit nil
### GetHash

`func (o *VPC) GetHash() string`

GetHash returns the Hash field if non-nil, zero value otherwise.

### GetHashOk

`func (o *VPC) GetHashOk() (*string, bool)`
...
`func (o *VPC) SetHash(v string)`

SetHash sets Hash field to given value.

### HasHash

`func (o *VPC) HasHash() bool`

HasHash returns a boolean if a field has been set.

### SetHashNil

`func (o *VPC) SetHashNil(b bool)`

 SetHashNil sets the value for Hash to be an explicit nil

### UnsetHash
`func (o *VPC) UnsetHash()`
