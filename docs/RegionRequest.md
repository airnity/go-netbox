...
`func (o *RegionRequest) GetOwner() CustomFieldRequestOwner`

GetOwner returns the Owner field if non-nil, zero value otherwise.

### GetOwnerOk

`func (o *RegionRequest) GetOwnerOk() (*CustomFieldRequestOwner, bool)`
...
`func (o *RegionRequest) SetOwner(v CustomFieldRequestOwner)`
