...
`func (o *PatchedWebhookRequest) GetOwner() CustomFieldRequestOwner`

GetOwner returns the Owner field if non-nil, zero value otherwise.

### GetOwnerOk

`func (o *PatchedWebhookRequest) GetOwnerOk() (*CustomFieldRequestOwner, bool)`
...
`func (o *PatchedWebhookRequest) SetOwner(v CustomFieldRequestOwner)`
