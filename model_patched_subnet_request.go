...
// checks if the PatchedSubnetRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedSubnetRequest{}

// PatchedSubnetRequest Adds support for custom fields and tags.
type PatchedSubnetRequest struct {
	// Name of the Subnet
...
type _PatchedSubnetRequest PatchedSubnetRequest
...
func (o *PatchedSubnetRequest) SetVpcNil() {
	o.Vpc.Set(nil)
}
...
func (o *PatchedSubnetRequest) SetRegionNil() {
	o.Region.Set(nil)
}
...
func (o *PatchedSubnetRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *PatchedSubnetRequest) SetPurposeNil() {
	o.Purpose.Set(nil)
}
...
func (o *PatchedSubnetRequest) SetHashNil() {
	o.Hash.Set(nil)
}
...
func (o PatchedSubnetRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedSubnetRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedSubnetRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedSubnetRequest := _PatchedSubnetRequest{}

	err = json.Unmarshal(data, &varPatchedSubnetRequest)

	if err != nil {
		return err
	}

	*o = PatchedSubnetRequest(varPatchedSubnetRequest)
...
type NullablePatchedSubnetRequest struct {
	value *PatchedSubnetRequest
	isSet bool
}

func (v NullablePatchedSubnetRequest) Get() *PatchedSubnetRequest {
	return v.value
}

func (v *NullablePatchedSubnetRequest) Set(val *PatchedSubnetRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedSubnetRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedSubnetRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedSubnetRequest(val *PatchedSubnetRequest) *NullablePatchedSubnetRequest {
	return &NullablePatchedSubnetRequest{value: val, isSet: true}
}

func (v NullablePatchedSubnetRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedSubnetRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
